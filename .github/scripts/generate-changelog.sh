...
#
# Environment:
#   TAG                tag being released, e.g. v0.1.253      (required)
#   VERSION            version being released, e.g. 0.1.253   (required)
...
{
  echo "Nightly release \`${VERSION}\`, published to [crates.io](https://crates.io/crates/cljrs)."
  echo
